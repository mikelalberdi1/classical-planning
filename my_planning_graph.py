...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~act in actionA.effects for act in actionB.effects] or [~act in actionB.effects for act in actionA.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~act in actionA.preconditions for act in actionB.effects] + [~act in actionB.preconditions for act in actionA.effects])
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any(self.parent_layer.is_mutex(actA,actB) for actA in actionA.preconditions for actB in actionB.preconditions)\
                or any(self.parent_layer.is_mutex(actB,actA) for actA in actionA.preconditions for actB in actionB.preconditions)
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        return all(self.parent_layer.is_mutex(actA, actB) for actA in self.parents[literalA] for actB in self.parents[literalB])\
                and all(self.parent_layer.is_mutex(actB, actA) for actA in self.parents[literalA] for actB in self.parents[literalB])
...
class PlanningGraph:
    ...
    def h_levelsum(self):
        ...
        for goals in self.goal:
            for idx, ll in enumerate(self.literal_layers):
                if goals in ll:
                    cost += idx
                    break
        return cost     
    ...
    def h_maxlevel(self):
        ...
        max_cost = 0
        for goals in self.goal:
            for cost, ll in enumerate(self.literal_layers):
                if goals in ll:
